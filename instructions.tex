...
\begin{tikzpicture}
    \node (G) at ( 0, 6) {\usebox{\Anb}};
    \node (A) at ( 5, 6) {\usebox{\Gnb}};
    \node (R) at ( 8, 6) {\usebox{\Rnb}};
    \node (H) at (11, 6) {\usebox{\Bnb}};
    \node (B) at (14, 6) {\usebox{\HHnb}};
    \node (C) at ( 0, 2) {\usebox{\Tnb}};
    \node (T) at ( 5, 2) {\usebox{\Cnb}};
    \node (Y) at ( 8, 2) {\usebox{\Ynb}};
    \node (D) at (11, 2) {\usebox{\Vnb}};
    \node (V) at (14, 2) {\usebox{\Dnb}};
    \node (S) at ( 0, 0) {\usebox{\Wnb}};
    \node (W) at ( 5, 0) {\usebox{\SSSnb}};
...
% \draw [lightgrey, line width=2pt] (-1.5,1.0) -- (6.5,1) -- (6.5, -1.0) -- (9.5, -1,0) -- (9.5, 5.0) -- (12.5, 5,0) -- (12.5, 7.0) -- (-1.5, 7.0) -- cycle;
    ...
    \draw [lightgrey, line width=2pt] (-1.5,1.0) -- (6.5,1) -- (6.5, -1.0) -- (9.5, -1,0) -- (9.5, 7.0) -- (-1.5, 7.0) -- cycle ;
    \draw [lightgrey, line width=2pt] (12.5, 5,0) -- (12.5, 7.0) -- (15.5, 7.0) -- (15.5, 5) -- cycle;
