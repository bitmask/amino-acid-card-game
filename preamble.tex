...
%\definecolor{C}{cmyk}{0.00,0.20,0.00,0.00}
%\definecolor{G}{cmyk}{0.23,0.00,0.00,0.00}

% flipped so that weak are light colours and strong are dark colours
\definecolor{G}{cmyk}{0.82,0.62,0.11,0.00}
\definecolor{C}{cmyk}{0.31,1.00,0.70,0.35}
\definecolor{T}{cmyk}{0.00,0.20,0.00,0.00}
\definecolor{U}{cmyk}{0.00,0.20,0.00,0.00}
\definecolor{A}{cmyk}{0.23,0.00,0.00,0.00}

\definecolor{lightblue}{cmyk}{0.23,0.00,0.00,0.00}
...
\savebox{\A}{%
    ...
    \widefont \Huge
        ...
        \node [,black] at (1.5 + 0.4,0.5) {\textbf A};
...
\savebox{\T}{%
    ...
    \widefont \Huge
        ...
        \draw [black, fill=white] (1 + 0.4,0) rectangle (2 + 0.4,1);
        \node [,black] at (1.5 + 0.4,0.5) {\textbf T};
        \path [use as bounding box] (0,0) rectangle (2 + 0.4,1);
    \end{tikzpicture}
}
...
\savebox{\U}{%
    ...
    \widefont \Huge
        ...
        \draw [black, fill=white] (1 + 0.4,0) rectangle (2 + 0.4,1);
        \node [,black] at (1.5 + 0.4,0.5) {\textbf U};
        \path [use as bounding box] (0,0) rectangle (2 + 0.4,1);
    \end{tikzpicture}
}
...
\savebox{\C}{%
    ...
    \widefont \Huge
        ...
        \node [,white] at (1.5 + 0.4,0.5) {\textbf C};
        \path [use as bounding box] (0,0) rectangle (2 + 0.4,1);
    \end{tikzpicture}
}
...
\savebox{\G}{%
    ...
    \widefont \Huge
        ...
        \draw [black, fill=black] (1 + 0.4,0) rectangle (2 + 0.4,1);
        \node [,white] at (1.5 + 0.4,0.5) {\textbf G};
        \path [use as bounding box] (0,0) rectangle (2 + 0.4,1);
    \end{tikzpicture}
}
...
\savebox{\D}{
    \begin{tikzpicture}[base]
    \widefont \Huge
        \draw [black, fill=T] (0,0) rectangle (1 + 0.4, 0.3333);
        \draw [black, fill=G] (0,0.3333) rectangle (1 + 0.4, 0.6666);
        \draw [black, fill=A] (0,0.6666) rectangle (1 + 0.4, 1);
        \draw [black, fill=lightgrey] (1 + 0.4,0) rectangle (2 + 0.4, 1);
...
\savebox{\Dnb}{%
    \begin{tikzpicture}[base]
    \widefont \Huge
        \draw [black, fill=T] (0,0) rectangle (1, 0.3333);
        \draw [black, fill=G] (0,0.3333) rectangle (1, 0.6666);
        \draw [black, fill=A] (0,0.6666) rectangle (1, 1);
        \draw [black, fill=lightgrey] (1,0) rectangle (2, 1);
...
\newcommand{\guanine}{
    ...
    \chemfig[line width=2pt, scale=1.1][scale=1.1]{[:-60]-[,2]N*5(-*6(-N=(-@{g3}H_2N)-[,,,2]@{g2}HN-[,,2,](=@{g1}O)-=)--N=-)}
}

\newcommand{\cytosine}{
    \chemfig[line width=2pt, scale=1.1, rotate=180][scale=1.1, rotate=180]{[:-120]-[,2]N*6(-=-(-@{c1}H_2N)=@{c2}N-(=@{c3}O)-)}
}

\newcommand{\hbondgc}{
    \chemmove{ \draw[lightgray, line width=4pt, line cap=round, shorten >=15pt, shorten <=5pt, dash pattern = on 0.5pt off 8pt] (g1) to[out=290, in=70] (c1); }
    \chemmove{ \draw[lightgray, line width=4pt, line cap=round, shorten >=10pt, shorten <=5pt, dash pattern = on 0.5pt off 8pt] (g2) to[out=240, in=125] (c2); }
    \chemmove{ \draw[lightgray, line width=4pt, line cap=round, shorten >=15pt, shorten <=5pt, dash pattern = on 0.5pt off 8pt] (g3) to[out=240, in=135] (c3); }
}
...
\newcommand{\ntcard}[2] {
    \begin{tikzpicture}[card]
        ...
        {
            \node[anchor=north] at (stock page.north) {\molecule{\guanine}};
            \node[anchor=south] at (stock page.south) {\molecule{\cytosine}};
            \hbondgc;
        }
...
\newcommand{\referencemutation} {
    ...
    \path
        ...
        \node (comp1) [rotate=90, anchor=center] at ($(A)!0.5!(T)$) {\scalefont{1.4}{{Complement}}};
        \node (comp2) [rotate=90, anchor=center] at ($(G)!0.5!(C)$) {\scalefont{1.4}{{Complement}}};
        \node (trans1) [rotate=90, anchor=center] at ($(A)!0.5!(G)$) {\scalefont{1.4}{{Transition}}};
        \node (trans2) [rotate=90, anchor=center] at ($(T)!0.5!(C)$) {\scalefont{1.4}{{Transition}}};
        \node (transv) [rotate=90, anchor=center] at ($(T)!0.5!(G)$) {\scalefont{1.4}{{Transversion}}};

        \node (fliptrans) [align=center, anchor=center, rotate=90, yshift=-10pt, xshift=-5pt, anchor=center, grey] at ($(trans1)!0.45!(G)$) {flip};
        \node (linestart) [below right=0.2cm of fliptrans.south west] {};
        \node (lineend) [above right=0.2cm of fliptrans.south east] {};
        \draw [-latex, line width=1pt, grey] (linestart) -- (lineend);

        \node (arcstart) [align=center, anchor=center, rotate=90, xshift=-0.75cm, grey] at ($(comp1)!0.4!(T)$) {rotate};
        \draw [latex-, line width=1pt, grey] (arcstart) ++(0:0.5cm) arc (0:+180:0.5cm);

        \node (fliptransv) [align=right, anchor=east, rotate=90, xshift=0.75cm, grey] at ($(transv)!0.5!(C)$) {flip};
        \node (linestart) [above left=0.2cm of fliptransv.north east] {};
        \node (lineend) [above right=0.2cm of fliptransv.south east] {};
        \draw [-latex, line width=1pt, grey] (linestart) -- (lineend);
...
\newcommand{\insertcard} {
    \begin{tikzpicture}[card]
        ...
        \node [below = 3.0cm, text width=3.5cm, align=center, anchor=center] at (trimmed page.center) {\normalsize Roll the black die to insert a random nucleotide anywhere in the sequence.};
...
\newcommand{\extend} {
    \begin{tikzpicture}[card]
        ...
        \node [below = 3.0cm, text width=4cm, align=center, anchor=center] at (trimmed page.center) {\normalsize Roll the white die to insert a random nucleotide at the end of the sequence.  May be used multiple times in one round.};
...
\newcommand{\revcompseq} {
    \begin{tikzpicture}[card]
        ...
        \draw [bend right, line width = 2pt, latex-latex, shorten >=2pt] (fiveprime.south east) to (threeprime.south west);

        \node [below = 2.5cm, text width=4cm, align=center, anchor=center] at (trimmed page.center) {\scalefont{1.4}{Swap} \normalsize the 5' and 3' ends to read the sequence in the opposite direction on the opposite strand.};
